...
describe("contracts", () => {
  const payload = {
    projects: {
      ...
      "mahal-webpack-loader":
        "github.com/ujjwalguptaofficial/mahal-webpack-loader",
  ...
  before(async () => {
    ...
    const [signer1, signer2, signer3, signer4, operator] =
  ...
  it("deploy erc20 token1", async () => {
    ...
    await payload.erc20Token1.mint(
  ...
  it("deploy erc20 token 2", async () => {
    ...
    await payload.erc20Token2.mint(
      payload.signer4.address,
