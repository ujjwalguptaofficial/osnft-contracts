    ...
    describe("auction sale priority set", () => {
        ...
        describe("update sellPriority", () => {
            ...
            it('gas estimate', async () => {
                ...
                expect(gasForPrioritySale).equal(86352);
            })
            ...
            it('non owner - success', async () => {
                ...
                const nftSaleInfoBefore = await marketplace.getAuction(auctionId);
    ...
    describe("general sell", () => {
        ...
        describe("update sellPriority", () => {
            ...
            it('gas estimate', async () => {
                ...
                expect(gasForPrioritySale).equal(74746);
            })
